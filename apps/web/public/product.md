...
MicAway is free and open source under the MIT License. Version 0.5.0 is a universal developer preview. Its downloadable application is ad-hoc signed but is not Developer ID signed or notarized, so macOS may require first-launch approval.
